...
# Select ROI for tracking for each point
p0s = []
...
# Draw initial tracking points
highlight_color = (0, 255, 0)  # Green
circle_radius = 5              
circle_thickness = -1          # -1 to fill the circle

frame_circle = old_frame.copy()
for p0 in p0s:
    frame_circle = cv2.circle(frame_circle, p0.astype(int).ravel(), circle_radius, highlight_color, circle_thickness)
